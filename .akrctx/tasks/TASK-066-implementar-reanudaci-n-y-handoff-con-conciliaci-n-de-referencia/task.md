...
Implementar reanudación y handoff con conciliación de referencias

## Status

BORRADOR P04; depende de TASK-064, TASK-065 y TASK-067. No iniciar implementación aún.

## Dependencies

- TASK-064: lector de continuación con digest de metadata y resumen de presupuesto declarado; la reconciliación efectiva, las transiciones y el escritor de progreso pertenecen a esta tarea junto al protocolo de reservas de TASK-065.
- TASK-065: reserva/exclusión antes de reanudar en paralelo.
- TASK-067: identidad de contenido y dos ejes de actualidad de revisión.
...
- Antes de implementar, convertir este borrador en una cápsula completa con casos sin commit, sin logs locales, sidecar actualizado y recuperación tras caída.
